...
\newcommand{\leftattack}{%
  \tikz[baseline=-0.5ex,scale=0.2]{\draw [arrows={-to[scale=0.5]}] (1.8,0.75) -- (0.7,0.75) -- (1.3,0.25) -- (0,0.25);}%
}
...
\newcommand{\keept}[2]{\operatorname{keep}(#1,#2)}
\newcommand{\keepc}[2]{(#1,#2)\operatorname{keep}}
